...
As you well know, this is the entry point for Microsoft Azure DevOps. Browser will show a view with a title "Sign in". I will call this view as "the Sign-in view" for short.
...
Please read this log. You can find that a `StaleElementReferenceException` was thrown by the line #38:
